...
class Tag(models.Model):
    ...
    color = models.CharField('Цветовой HEX-код', unique=True,)
    slug = models.SlugField('Уникальный слаг', unique=True, max_length=255,)
...
class Ingredient(models.Model):
    ...
    units = models.CharField('Единица измерения', max_length=15,)
...
class IngredientsInRecipe(models.Model):
    ...
    ingridient - Ингридиент из модели ингридиентов.
    amout - количество ингридиента.
    """
